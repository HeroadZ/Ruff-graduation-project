...
var colorControl = {
    colorInput: __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#colorInput'),
    colorArr: __WEBPACK_IMPORTED_MODULE_0_jquery___default()('input[name="color"]'),

    inputFocus: function inputFocus() {
        colorControl.colorInput.focus(function () {
            for (var i = 0; i < colorControl.colorArr.length; i++) {
    ...
    colorSubmit: function colorSubmit() {
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#colorSubmit').click(function () {
            var colorCode = '';
            ...
            if (confirm("确认修改吗？")) {
                ...
                __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.get(localStorage.getItem('ruffUrl') + 'colorChange?color=' + encodeURIComponent(colorCode), function (data, status) {
                    if (status === 'success') {
